# Sourced from MIT licensed https://github.com/dmontagu/fastapi-utils/blob/master/tests/test_tasks.py
# The full dependency couldn't be utilised due to not supporting SQLAlchemy 2.0
