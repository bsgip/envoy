...
SELECT pg_catalog.setval('public.certificate_certificate_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.aggregator_certificate_assignment_assignment_id_seq', 5, true);
