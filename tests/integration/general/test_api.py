...
ALL_ENDPOINTS_WITH_SUPPORTED_METHODS: list[tuple[list[HTTPMethod], str]] = [
    ...
    ([HTTPMethod.GET, HTTPMethod.HEAD], "/edev/1/tp/1/rc/1"),
    ([HTTPMethod.GET, HTTPMethod.HEAD], "/edev/1/tp/1/rc/1/rt"),
    ([HTTPMethod.GET, HTTPMethod.HEAD], "/edev/1/tp/1/rc/1/tti"),
    ([HTTPMethod.GET, HTTPMethod.HEAD], "/edev/1/tp/1/rc/1/tti/1/cti"),
    ([HTTPMethod.GET, HTTPMethod.HEAD], "/edev/1/tp/1/rc/1/tti/1/cti/1"),
