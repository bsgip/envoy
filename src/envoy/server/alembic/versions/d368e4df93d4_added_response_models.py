...
Revision ID: d368e4df93d4
Revises: 5c4cb6749db0
Create Date: 2025-03-07 16:32:02.221883
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("dynamic_operating_envelope_response_id", sa.BigInteger(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("tariff_generated_rate_response_id", sa.BigInteger(), nullable=False),
