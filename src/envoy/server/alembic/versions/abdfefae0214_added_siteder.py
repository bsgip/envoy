...
def upgrade() -> None:
    ...
    op.create_table('site_der_availability',
    ...
    op.create_index(op.f('ix_site_der_availability_changed_time'), 'site_der_availability', ['changed_time'], unique=False)
    op.create_table('site_der_rating',
    ...
    op.create_table('site_der_setting',
    ...
    op.create_table('site_der_status',
