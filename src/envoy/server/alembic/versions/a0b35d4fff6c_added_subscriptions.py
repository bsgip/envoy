...
def upgrade() -> None:
    ...
    op.create_table('aggregator_domain',
    ...
    sa.ForeignKeyConstraint(['aggregator_id'], ['aggregator.aggregator_id'], ),
    sa.ForeignKeyConstraint(['scoped_site_id'], ['site.site_id'], ),
    sa.PrimaryKeyConstraint('subscription_id')
    )
    op.create_index('aggregator_id', 'subscription', ['resource_type'], unique=False)
    op.create_table('subscription_condition',
    ...
    op.create_index(op.f('ix_dynamic_operating_envelope_changed_time'), 'dynamic_operating_envelope', ['changed_time'], unique=False)
    ...
    op.create_index(op.f('ix_tariff_generated_rate_changed_time'), 'tariff_generated_rate', ['changed_time'], unique=False)
