...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column("generation_limit_watts", sa.DECIMAL(precision=16, scale=2), nullable=True),
    )
    op.add_column(
        "dynamic_operating_envelope", sa.Column("load_limit_watts", sa.DECIMAL(precision=16, scale=2), nullable=True)
    )
    op.add_column(
        "dynamic_operating_envelope", sa.Column("max_limit_percent", sa.DECIMAL(precision=5, scale=2), nullable=True)
    )
    ...
    op.add_column(
        "archive_dynamic_operating_envelope",
        sa.Column("load_limit_watts", sa.DECIMAL(precision=16, scale=2), nullable=True),
    )
    op.add_column(
        "archive_dynamic_operating_envelope",
        sa.Column("max_limit_percent", sa.DECIMAL(precision=5, scale=2), nullable=True),
    )
